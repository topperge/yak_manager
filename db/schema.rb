...
ActiveRecord::Schema.define(:version => 20120313203230) do
  ...
  create_table "contractor_file_records", :force => true do |t|
    t.string   "clid"
    t.string   "email"
    t.string   "flag"
  ...
  create_table "contractor_files", :force => true do |t|
    ...
    t.integer  "users_found"
    t.integer  "users_not_changed"
  end
